...
################################################################################
## Form generated from reading UI file 'ui_design - CopyioPKsA.ui'
##
...
"	border-width:1px;\n"
"	border-style:Inset;\n"
"	background-image: url(:/newPrefix/resources/icons/cil-home.png);\n"
"	background-repeat:none;\n"
"	background-position:left;\n"
"	\n"
"	border-color: rgb(29, 29, 29);\n"
...
"	border-width:1px;\n"
"	border-style:Inset;\n"
"	background-image: url(:/newPrefix/resources/icons/cil-envelope-closed.png);\n"
"	background-repeat:none;\n"
"	background-position:left;\n"
"	\n"
"	border-color: rgb(29, 29, 29);\n"
...
"	border-width:1px;\n"
"	border-style:Inset;\n"
"	background-image: url(:/newPrefix/resources/icons/cil-settings.png);\n"
"	background-repeat:None;\n"
"	background-position:left;\n"
"	border-color: rgb(29, 29, 29);\n"
"	border-bottom-color: rgb(163, 0, 0);\n"
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.SearchBar_frame.sizePolicy().hasHeightForWidth())
        self.SearchBar_frame.setSizePolicy(sizePolicy5)
...
"}")
        icon = QIcon()
        icon.addFile(u":/newPrefix/resources/icons/cil-arrow-circle-left.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/newPrefix/resources/icons/cil-reload.png", QSize(), QIcon.Normal, QIcon.Off)
        self.hm_brow_reload_btn.setIcon(icon1)
        self.hm_brow_reload_btn.setIconSize(QSize(23, 20))
...
"}")
        icon2 = QIcon()
        icon2.addFile(u":/newPrefix/resources/icons/cil-arrow-circle-right.png", QSize(), QIcon.Normal, QIcon.Off)
        self.hm_brow_foward_btn.setIcon(icon2)
        ...
        self.Latitude_2 = QLineEdit(self.frame_11)
        self.Latitude_2.setObjectName(u"Latitude_2")
        sizePolicy5.setHeightForWidth(self.Latitude_2.sizePolicy().hasHeightForWidth())
        self.Latitude_2.setSizePolicy(sizePolicy5)
        self.Latitude_2.setMinimumSize(QSize(239, 33))
        font5 = QFont()
        font5.setPointSize(14)
        self.Latitude_2.setFont(font5)
        self.Latitude_2.setStyleSheet(u"QLineEdit{\n"
"image:none;\n"
...
"\n"
"}")
        self.Latitude_2.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_20.addWidget(self.Latitude_2)
...
"}")
        icon3 = QIcon()
        icon3.addFile(u":/newPrefix/resources/icons/cil-paper-plane.png", QSize(), QIcon.Normal, QIcon.Off)
        self.Home_search_button.setIcon(icon3)
        self.Home_search_button.setIconSize(QSize(29, 29))
...
"background-color: qlineargradient(spread:pad, x1:0.511364, y1:0, x2:0.522455, y2:1, stop:0 rgba(61, 61, 61, 167), stop:1 rgba(28, 28, 28, 160));")
        ...
        sizePolicy5.setHeightForWidth(self.Latitude.sizePolicy().hasHeightForWidth())
        self.Latitude.setSizePolicy(sizePolicy5)
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.Longitude.sizePolicy().hasHeightForWidth())
        self.Longitude.setSizePolicy(sizePolicy5)
...
#if QT_CONFIG(tooltip)
        self.Latitude_2.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:11pt; color:#ffffff;\">Search Bar</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.Latitude_2.setText("")
        self.Latitude_2.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Search", None))
#if QT_CONFIG(tooltip)
